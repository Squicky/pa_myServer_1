...
void ServerClientClass::rec_threadRun() {
    ...
    memset((char *) &(arbeits_paket_send->puffer), 83, sizeof (arbeits_paket_send->puffer));
    ...
    timeout_time.tv_usec = 10000; // Anzahl Mikrosekunden : 1 Sek. = 1.000.000 Mikrosekunden
    /*
